...
public class newAddSportActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Lors de la création d'une session, si aucun nom n'est donné, nous
        // utilisons "Session" par défaut. Sinon, nous conservons le nom fourni dans la base de données et l'appliquons au graphique.

        if (dataBaseSports.getLastSessionName() == null) {
            dataBaseSports.setLastNameSport("Session");
        }else{
            name_session.setText(dataBaseSports.getLastSessionName());
        }
        ...
        add_session.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //TODO: Quand je valide la séance, il faut que chaque exo ait au moint une série. Supprimer ou demander confirmation à utilisateur
            }
        });
        name_session.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                System.out.println(dataBaseSports.getLastSessionName());
            }
            @Override
